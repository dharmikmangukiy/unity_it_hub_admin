...
const Withdraw = (prop) => {
  ...
  const manageContent = () => {
    if (dialogTitle == "Add New Withdrawal") {
      ...
      return (
        <div>
          <div className="withdrawal-action-popup-text">
            <label>Are you want to sure reject this IB withdrawal ?</label>
          </div>
        </div>
      );
    } else if (dialogTitle == "Approve") {
      return (
        <div>
          <div className="withdrawal-action-popup-text">
            <label>Are you want to sure approve this IB withdrawal ?</label>
          </div>
        </div>
      );
    } else if (dialogTitle == "View Withdrawal RM Details") {
          ...
          {popLoder ? (
            ...
            <div className="withdrawal-action-popup-text">
              <div className="view-commission-content-section">
                ...
                <div className="view-content-element">
                  <h6 className="element-title">Salse Manager Name</h6>
                  <div className=" element-content">
                    {ViewRM.sales_manager_name}
                  </div>
                </div>
                <div className="view-content-element">
                  <h6 className="element-title">Salse Manager Email</h6>
                  <div className=" element-content">
  ...
  const ViewRmFunc = (row) => {
    ...
    param.append("ib_withdrawal_id", row.ib_withdrawal_id);
  ...
  const submitUpdate = async () => {
    if (viewWithdrawForm.amount == "") {
      ...
      param.append("ib_withdrawal_id", viewWithdrawForm.withdrawal_id);
      if (resData.role_name == "Risk_Management") {
        param.append("status", viewWithdrawForm.rm_status);
      } else {
  ...
  const viewWithdrawl = (row) => {
    ...
    setviewWithdrawForm({
      ...
      user_id: "",
      withdrawal_id: row.ib_withdrawal_id,
      isLoader: false,
    });
    if (resData.role_name == "Risk_Management") {
                          ...
                          <div className="card padding-9 animate fadeLeft boxsize">
                            <div className="row">
                              <div className="col s12 m12 text-align-center">
                                ...
                                <p className="no-margin">IB Withdraw</p>
                              </div>
                            </div>
                          </div>
                        </div>

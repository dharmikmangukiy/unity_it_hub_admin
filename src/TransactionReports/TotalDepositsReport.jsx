          ...
          <div style={{ opacity: 1 }}>
            <Grid container>
              <Grid item md={12} lg={12} xl={12}>
                <p className="main-heading">Total Deposits Report</p>
                <CommonFilter
                  search={searchBy}
                  setParam={setParam}
                    ...
                    <Grid container spacing={2}>
                      <Grid item sm={12} md={12} lg={12}>
                        <CommonTable
                          ...
                          csv="datatable/total_deposit_list_export.php"
                        />
                      </Grid>
                    </Grid>
                  </CardContent>
...
export default TotalDepositsReport;
